...
<!-- wp:group {"align":"wide"} -->
<!-- wp:heading -->
<h2>Digital Ad Specs</h2>
<!-- /wp:heading -->
<div class="wp-block-group alignwide"><!-- wp:newspack/tabs -->
<!-- wp:newspack/tabs-item {"header":"Standard Display"} -->
<!-- wp:table -->
...
<!-- wp:newspack/tabs-item {"header":"Video"} -->
<!-- wp:table -->
...
<!-- wp:newspack/tabs-item {"header":"Native"} -->
<!-- wp:table -->
